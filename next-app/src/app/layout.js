...
export const metadata = {
  ...
  description: "Explore the portfolio of David Riva, a software engineer specializing in applied AI, full-stack development, and data engineering. View projects involving React, Next.js, and AI/ML.",
  keywords: ["David Riva", "Software Engineer", "Applied AI Engineer", "Full Stack Developer", "React Developer", "Portfolio", "Web Development"],
  openGraph: {
    title: 'David Riva - Software Engineer',
