        ...
        {msg.role === 'assistant' ? (
          showDots ? (
            <Box sx={{ display: 'flex', alignItems: 'center', py: 0.5 }}>
              <BouncingDotsLoadingAnimation dotSize={7} dotColor="#38bdf8" spacing={4} />
            </Box>
          ) : (
            <ReactMarkdown
              components={{
                ...
                h1: (props) => <Typography sx={{ ...mdStyles, fontWeight: 700, fontSize: '1.25rem', mt: 2, mb: 1, color: '#fafafa' }} {...props} />,
                h2: (props) => <Typography sx={{ ...mdStyles, fontWeight: 700, fontSize: '1.1rem', mt: 1.5, mb: 0.8, color: '#fafafa' }} {...props} />,
                h3: (props) => <Typography sx={{ ...mdStyles, fontWeight: 600, fontSize: '1rem', mt: 1.2, mb: 0.6, color: '#fafafa' }} {...props} />,
                code: (props) => (
                  <Box
                    component="code"
                    sx={{
